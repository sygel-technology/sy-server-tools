...
.. |badge3| image:: https://img.shields.io/badge/github-sygel--technology%2Fsy--server--tools-lightgray.png?logo=github
    :target: https://github.com/sygel-technology/sy-server-tools/tree/17.0/reports_font_size
...
-  You can the text size, text size unit, header size, and header size
   unit
...
`feedback <https://github.com/sygel-technology/sy-server-tools/issues/new?body=module:%20reports_font_size%0Aversion:%2017.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `sygel-technology/sy-server-tools <https://github.com/sygel-technology/sy-server-tools/tree/17.0/reports_font_size>`_ project on GitHub.
